        ...
        <section className={styles.recentContainer}>
          ...
          <div className={styles.recentContent}>
            <Recentpost posts={[
              {
                slug: 'teste',
                title: 'Como funciona o Artigo 157',
                description: 'O artigo fala sobre quem é bandido tem que morrer e acabou taokay?...',
                cover: 'images/imagemteste.png',
                updatedAt: 'jun 21, 2022',
              }, 
              {
                slug: 'teste',
                title: 'Como funciona o Artigo 157',
